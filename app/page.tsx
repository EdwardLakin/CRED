...
export const metadata: Metadata = {
  title: 'CRED | Turn field evidence into professional reports',
  description:
    'CRED turns photos, forms, notes, and documents into professional reports for field teams, claims professionals, and evidence-heavy investigations.',
  openGraph: {
    title: 'CRED | Field evidence to professional reports',
    description:
...
const essentialsScreenshots: ProductScreenshotCardProps[] = [
  ...
  { title: 'Evidence Library', eyebrow: 'Evidence Library', description: 'Keep source material organized so reviewers can see what supports the report.', src: '/marketing/cred/evidence-library.png', alt: 'CRED Evidence Library showing organized source evidence' },
  { title: 'Existing Report', eyebrow: 'Review', description: 'Review the prepared report, correct details, add signatures, and approve before delivery.', src: '/marketing/cred/review-edit.png', alt: 'CRED Existing Report review and approval screen' },
...
const tierScreenshots: Record<CredTier, ProductScreenshotCardProps[]> = {
  ...
  professional: [
    { title: 'Review Queue', eyebrow: 'Professional', description: 'Process unresolved evidence and suggestions in a structured review workflow.', src: '/marketing/cred/review-queue.png', alt: 'CRED Review Queue for structured evidence review' },
    { title: 'Timeline and observations', eyebrow: 'Professional', description: 'Organize dated events, factual observations, suggestions, and deliverables.', src: '/marketing/cred/timeline-observations.png', alt: 'CRED Timeline and Factual Observations workspace' },
  ],
  investigation: [
    { title: 'Entities', eyebrow: 'Investigation', description: 'Organize people, places, assets, and organizations in an investigation workspace.', src: '/marketing/cred/entities.png', alt: 'CRED Entities workspace for investigation evidence organization' },
    { title: 'Relationship Explorer', eyebrow: 'Investigation', description: 'Explore links between evidence, events, entities, observations, and deliverables.', src: '/marketing/cred/relationship-explorer.png', alt: 'CRED Relationship Explorer showing evidence relationships' },
  ],
}
...
const tierProgression = [
  ...
  ['Organize', 'CRED Professional', ['Review', 'Timeline', 'Observations', 'Deliverables']],
  ['Investigate', 'CRED Investigation', ['Entities', 'Relationships', 'Evidence linking', 'Investigation packages']],
] as const
...
const useCasesByTier = [
  ...
  ['Professional use cases', ['claims documentation', 'compliance reviews', 'multi-stage inspections', 'condition histories', 'structured evidence review', 'team-based report preparation']],
  ['Investigation use cases', ['legal evidence packages', 'insurance investigations', 'dispute documentation', 'forensic case files', 'expert-witness documentation', 'relationship and chronology analysis']],
] as const

const faqs = [
  ['What is the difference between Essentials, Professional, and Investigation?', 'Essentials is a complete documentation product for capture, report review, approval, and export. Professional adds structured evidence review, timelines, observations, suggestions, and deliverables. Investigation adds entities, relationships, evidence linking, and investigation deliverables.'],
  ...
  ['Can a company manage multiple shops, offices, or teams?', 'Yes. Use one workspace for each team, shop, office, or location so users, sessions, reports, and evidence stay scoped together.'],
  ...
  ['Are investigation tools included in Essentials?', 'No. Essentials focuses on documentation. Investigation tools such as Entities and Relationship Explorer are available in CRED Investigation.'],
    ...
    <main className="landing-shell">
      ...
      <section className="landing-hero">
        <div className="landing-hero-content">
          ...
          <h1>Turn field evidence into professional reports.</h1>
      ...
      <section className="landing-section workflow-screenshots-section" aria-labelledby="essentials-screenshots-title"><div className="section-kicker">Essentials workflow</div><h2 id="essentials-screenshots-title">A complete product for field documentation.</h2><p className="section-copy">Essentials starts with capture and keeps the Evidence Library, Existing Report, review, approval, and export path clear.</p><div className="screenshot-grid product-screenshot-grid">{essentialsScreenshots.map((screenshot) => <ProductScreenshotCard key={screenshot.title} {...screenshot} />)}</div></section>
