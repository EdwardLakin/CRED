...
export type ReportStudioSession = { id: string; display_id: string | null; title: string | null; status: string | null; review_status: string | null; updated_at: string | null; customer_name: string | null; asset_label: string | null; report_draft_id?: string | null; report_summary?: string | null; evidence: EvidenceItem[]; snapshot: FinalReportSnapshot };
