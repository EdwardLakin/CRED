...
export type ReportStudioSection = "cover" | "header" | "clientAsset" | "evidence" | "footer" | "signature" | "colors" | "typography";
...
export type ReportStudioSession = { id: string; display_id: string | null; title: string | null; status: string | null; review_status: string | null; updated_at: string | null; customer_name: string | null; asset_label: string | null; evidence: EvidenceItem[] };
