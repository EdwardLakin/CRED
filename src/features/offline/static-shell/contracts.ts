...
export type ReachabilityResult = { ok: boolean; status: 'offline' | 'api_unavailable' | 'unauthenticated' | 'auth_mismatch' | 'ready'; userId?: string; organizationId?: string; error?: string };
