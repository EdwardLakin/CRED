...
export const SYSTEM_TEMPLATES: TemplateDraft[] = [

  {
    ...
    description: 'AI-guided battery test and charging system workflow with form-aware readings, evidence requirements, and pass/fail thresholds.',
    templateType: 'system',
    ...
    pdfLayout: { sections: ['Summary', 'Battery Test Form', 'Evidence', 'Findings', 'Signatures'], includeEvidenceGallery: true, includeSignatures: true },
  },
  {
    name: 'Safety Inspection',
    description: 'Required safety item workflow with defect evidence, critical finding escalation, and final technician approval.',
    templateType: 'system',
    ...
    pdfLayout: { sections: ['Summary', 'Safety Items', 'Critical Findings', 'Evidence', 'Signatures'], includeEvidenceGallery: true, includeSignatures: true },
  },
  {
    ...
    pdfLayout: { sections: ['Summary', 'Forklift Checks', 'Evidence', 'Defects', 'Signatures'], includeEvidenceGallery: true, includeSignatures: true },
  },
  {
    name: 'Fleet PM',
    description: 'Preventive maintenance inspection workflow with fluid, tire, brake, lighting, and service evidence gates.',
    templateType: 'system',
    ...
    signatureRequirements: [{ key: 'technician_approval', label: 'Technician Approval', required: true, matchTerms: ['technician approval', 'signature'] }],
    pdfLayout: { sections: ['Summary', 'PM Checklist', 'Evidence', 'Recommendations', 'Signatures'], includeEvidenceGallery: true, includeSignatures: true },
  },
  {
    name: 'Trailer Inspection',
    description: 'Trailer inspection workflow for VIN, brakes, tires, lights, coupling, deck/body, and defect evidence.',
    templateType: 'system',
    ...
    signatureRequirements: [{ key: 'inspector_signature', label: 'Inspector Signature', required: true, matchTerms: ['inspector signature'] }],
    pdfLayout: { sections: ['Summary', 'Trailer Items', 'Evidence', 'Findings', 'Signatures'], includeEvidenceGallery: true, includeSignatures: true },
  },
  {
