    ...
    <section className="card detail-card evidence-checklist-summary-card">
      <div className="captures-section-header">
        <div>
          ...
          <p className="muted">
            Compact capture coverage for this inspection. Expand for detailed guidance without leaving Session Details.
          </p>
        </div>
        <span className="ai-status-pill">{completeCount} of {summaries.length} groups</span>
      </div>

      <div className="compact-checklist-grid" aria-label="Evidence checklist summary">
      ...
      <details className="expanded-checklist-details">
        <summary className="secondary-link touch-target">Expand Checklist</summary>
