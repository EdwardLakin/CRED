...
type Capture = { id: string; technician_note: string | null; original_filename: string | null; captured_at: string | null; ai_summary?: string | null; extracted_text?: string | null }
