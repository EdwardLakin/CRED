...
Repository and production are **in sync** as of 2026-09-10: 69 migration files,
69 rows in `supabase_migrations.schema_migrations`, latest
`20260910140000_capture_item_severity`.
